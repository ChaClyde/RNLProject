    ...
    const handleLoadUsers = async () => {
        try {
            ...
            if (res.status === 200) {
                ...
                console.error('Unexpected status error occured during loading users: ',
                    res.status
                );
            }
        } catch (error) {
            console.error('Unexpected server error occured during loading users: ',
                error
            );
        } finally {
    ...
    return (
        <>
            <div className="overflow-hidden rounded-lg border border-gray-200 bg-white">
                <div className="max-w-full max-h-[calc(100vh-100px)] overflow-x-auto">
                    <Table>
