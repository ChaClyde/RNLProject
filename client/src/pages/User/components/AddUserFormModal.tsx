                ...
                <form>
                    ...
                    <div className="grid grid-cols-2 gap-4 border-b border-gray-100 mb-4">
                        <div className="col-span-2 md:col-span-1">
                            <div className='mb-4'>
                                <FloatingLabelInput label="First Name" type="text" name="firstName" required autoFocus />
                            </div>
                            <div className='mb-4'>
                                <FloatingLabelInput label="Middle Name" type="text" name="middleName" />
                            </div>
                            <div className='mb-4'>
                                <FloatingLabelInput label="Last Name" type="text" name="lastName" required />
                            </div>
                            <div className='mb-4'>
                                <FloatingLabelInput label="Suffix Name" type="text" name="suffixName" />
                            </div>
                            <div className='mb-4'>
