        ...
        <>
            ...
            <div className="mb-4">
                <FloatingLabelInput
                    ...
                    type="text"
                    name="first_name"
                    // newInputClassName="bg-black text-white" for additioal designs 
                    value={firstName}
                ...
                <div className="max-w-full max-h-[calc(100vh)] overflow-x-auto">
                    <Table>
                        <TableHeader className="border-b border-gray-100 bg-blue-600 text-white sticky top-0 z-30 text-xs" >
                            <TableRow>
                                <TableCell isHeader className="px-5 py-3 fone-medium text-center">No.</TableCell>
                                <TableCell isHeader className="px-5 py-3 fone-medium text-start">Gender</TableCell>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            {genders.map((gender, index) => (
